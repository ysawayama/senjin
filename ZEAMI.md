...
```yaml
What to Build: senjin - 人生の先輩から後輩へアドバイスを贈るサービス
Why Building: 経験者の生の声を、悩んでいる若者に届ける
Target Users: 学生や若者（スマートフォン利用を想定）
Key Features:
  - 悩みカテゴリー選択（進路/転職/就活/困難）
  - 先人のアドバイス閲覧
  - 勇気ブックへのアーカイブ
  - ポジティブコメント投稿
  - 管理画面（先人の声の登録・管理）
Success Criteria: 2025年12月末までに完成、エモーショナルなUI/UX実現
```
...
Frontend:
  ...
  font: Noto Sans JP / M PLUS Rounded 1c
...
Rationale: "1ヶ月開発に最適な高速スタック、エモーショナルUI実現可能"
```
